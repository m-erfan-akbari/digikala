...
export const categoryItems: CategoryItems = {
  ...
  3: {
    ...
    column2: [
      ...
      { title: "مبلمان و دکوراسیون اداری", items: [] },
      { title: "نگهدارنده لباس و لوازم", items: [] },
      { title: "دکوراتیو", items: [] },
      { title: "قاب عکس و تابلو", items: [] },
      { title: "کوسن، رومیزی و شال مبل", items: [] },
      { title: "کفپوش و دیوارپوش", items: [] },
      { title: "نور و روشنایی", items: [] },
      { title: "فرش و گلیم", items: [] },
      { title: "گل و گیاه", items: [] },
    ],
    column3: [
      { title: "حمام", items: [] },
      { title: "سرویس بهداشتی", items: [] },
      { title: "خواب", items: [] },
      { title: "شستشو و نظافت", items: [] },
      { title: "نظافت لباس", items: [] },
    ],
  },
  4: {
    column1: [
